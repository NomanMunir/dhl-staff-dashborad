...
export const setDefaultDateTime = () => {
  ...
  // Set from date to year 2022
  const fromDate = new Date(current);
  fromDate.setFullYear(2022);
  fromDateElem.value = fromDate.toISOString().substring(0, 10);
...
export const perfChartCheckboxElem = document.querySelector(
  "#perf-chart-checkbox"
);
export const uphChartCheckboxElem = document.querySelector(
  "#uph-chart-checkbox"
);
