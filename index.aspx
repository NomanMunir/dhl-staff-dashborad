...
<html>
  <head>
    ...
    ></script>
    <script
      src="https://cdnjs.cloudflare.com/ajax/libs/PapaParse/5.3.2/papaparse.js"
  ...
  <body>
    <nav
      class="navbar navbar-light navbar-light bg-warning shadow-sm"
      aria-label="Navbar"
    >
      <div class="container-fluid">
        <a
          href="#"
          class="d-flex ml-5 align-items-center mb-3 mb-md-0 me-md-auto text-decoration-none"
        >
          <img
            class="bi me-2"
            width="120"
              ...
              <li class="nav-item">
                ...
                >
                  <input
                    type="checkbox"
                    class="btn-check"
                    id="perf-chart-checkbox"
                    autocomplete="off"
                  />
                  <label
                    class="btn btn-outline-warning"
                    for="perf-chart-checkbox"
                    >Perf Chart</label
                  >
                  ...
                  <input
                    ...
                    autocomplete="off"
                  />
                  <label class="btn btn-outline-warning" for="table-checkbox"
                    >Table</label
                  >
                  ...
                  <input
                    ...
                    checked
                    class="btn-check"
                    id="uph-chart-checkbox"
                    autocomplete="off"
                  />
                  <label
                    class="btn btn-outline-warning"
                    for="uph-chart-checkbox"
                    >Uph Chart</label
                  >
                </div>
              </li>
    ...
    <section class="d-flex flex-column justify-content-center m-3 gx-3">
      <div
        class="mx-auto my-3 bg-white card"
        style="width: 98vw; height: auto"
        id="perf-charts"
      ></div>
      <div
        id="table"
        class="mx-auto my-3 bg-white"
        style="width: 98vw; height: auto"
      ></div>
      <div
